...
impl Canvas {
    ...
    pub fn draw_tri_raw(&mut self,
        ...
        // TODO: interpolate normals instead of averaging
        ...
        for x in bounds.0.0..=bounds.1.0 {
            for y in bounds.0.1..=bounds.1.1 {
                if Self::is_in_tri((x, y), p0, p1, p2) {
                    ...
                    let brightness = normal.dot((0.0, 1.0, 0.0).into()).clamp(0.0, 1.0);
    ...
    pub fn draw_tri(&mut self, p0: Float2, p1: Float2, p2: Float2, n0: Float3, n1: Float3, n2: Float3) {
        self.draw_tri_raw(
            self.coord_to_pixel(p0), self.coord_to_pixel(p1), self.coord_to_pixel(p2),
            n0, n1, n2,
        );
    }
